...
export default function PlayerInfo(props: PlayerInfoProps){
    ...
    return(
        <Container y={props.y}>
            ...
            <Container x={props.width} y={props.height * 0.25}>
                <Sprite image={'/assets/leaderboard-icons/path.png'} width={props.width * 0.7} height={props.height * 0.7}/>
                <Text style={new TextStyle({fontSize: props.fontSize})} text={props.score.toString()} x={props.width * 0.2} y={props.height * 0.7} />           
            </Container>
            <Container x={props.width * 1.85} y={props.height * 0.25}>
